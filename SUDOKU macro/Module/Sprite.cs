    ...
    public class Sprite : Dictionary<string, Sprite.Template>
    {
        public class Template
        {
            ...
            public Template(string name, byte[] template, float threshold = 0.95f)
            {
                ...
                this.Frame = Cv2.ImDecode(this.Bytes, ImreadModes.Unchanged);
            }
            ...
            public Nullable<OpenCvSharp.Point> MatchTo(Mat frame, PythonTuple begin = null, PythonTuple size = null, bool useBinaryThreshold = false)
            {
                ...
                return this.MatchTo(frame, ref percentage, new OpenCvSharp.Point((int)begin[0], (int)begin[1]), new OpenCvSharp.Size((int)size[0], (int)size[1]), useBinaryThreshold, false);
            }
